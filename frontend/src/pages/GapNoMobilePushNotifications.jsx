...
// Auto-generated page for: No mobile push notifications

export default function GapNoMobilePushNotifications() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-mobile-push-notifications', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No mobile push notifications</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No mobile push notifications</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No mobile push notifications'}
        </button>
      </form>
