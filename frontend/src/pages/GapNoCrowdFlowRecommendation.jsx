...
// Auto-generated page for: No crowd-flow recommendation

export default function GapNoCrowdFlowRecommendation() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-crowd-flow-recommendation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No crowd-flow recommendation</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No crowd-flow recommendation</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No crowd-flow recommendation'}
        </button>
      </form>
