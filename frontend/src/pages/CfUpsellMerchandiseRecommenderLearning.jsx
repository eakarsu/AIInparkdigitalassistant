...
// Auto-generated page for: Upsell + merchandise recommender learning visitor preference

export default function CfUpsellMerchandiseRecommenderLearning() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-upsell-merchandise-recommender-learning-', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Upsell + merchandise recommender learning visitor preference</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Upsell + merchandise recommender learning visitor preferences for in-park revenue.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Upsell + merchandise recommender learning visitor preference'}
        </button>
      </form>
