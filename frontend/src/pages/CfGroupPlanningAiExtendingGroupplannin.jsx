...
// Auto-generated page for: Group planning AI extending groupPlanning

export default function CfGroupPlanningAiExtendingGroupplannin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-group-planning-ai-extending-groupplannin', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Group planning AI extending groupPlanning</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Group planning AI extending groupPlanning.js to maximize shared experiences and minimize splits.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Group planning AI extending groupPlanning'}
        </button>
      </form>
