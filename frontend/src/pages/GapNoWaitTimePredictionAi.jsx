...
// Auto-generated page for: No wait-time prediction AI

export default function GapNoWaitTimePredictionAi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-wait-time-prediction-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No wait-time prediction AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No wait-time prediction AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No wait-time prediction AI'}
        </button>
      </form>
