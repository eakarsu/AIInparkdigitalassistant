...
// Auto-generated page for: Accessibility + inclusivity recommender for mobility/sensory

export default function CfAccessibilityInclusivityRecommenderFo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-accessibility-inclusivity-recommender-fo', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Accessibility + inclusivity recommender for mobility/sensory</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Accessibility + inclusivity recommender for mobility/sensory considerations.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Accessibility + inclusivity recommender for mobility/sensory'}
        </button>
      </form>
