...
// Auto-generated page for: No dining-queue prediction

export default function GapNoDiningQueuePrediction() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-dining-queue-prediction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No dining-queue prediction</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No dining-queue prediction</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No dining-queue prediction'}
        </button>
      </form>
